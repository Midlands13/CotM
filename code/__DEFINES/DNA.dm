...
#define MANDATORY_FEATURE_LIST list("mcolor" = "FFF", "mcolor2" = "FFF", "mcolor3" = "FFF", "ethcolor" = "9c3030", "legs" = "Normal Legs", "flavor_text" = "", "ooc_notes" = "", "body_size" = RESIZE_DEFAULT_SIZE)
