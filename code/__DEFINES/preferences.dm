...
#define ERP_NO				"No"
#define ERP_ASK				"Ask"
#define ERP_YES_DOM			"Yes - Dom"
#define ERP_YES_SWITCH		"Yes - Switch"
#define ERP_YES_SUB			"Yes - Bottom"

#define ERP_PREF_LIST list(ERP_NO, ERP_ASK, ERP_YES_DOM, ERP_YES_SWITCH, ERP_YES_SUB)

#define ERP_MECHANICS_NO	"No"
#define ERP_MECHANICS_RP	"Roleplay Only"
#define ERP_MECHANICS_YES	"Roleplay & Mechanics"

#define ERP_MECHANICS_LIST list(ERP_MECHANICS_NO, ERP_MECHANICS_RP, ERP_MECHANICS_YES)
